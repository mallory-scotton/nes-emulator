...
public:
    ///////////////////////////////////////////////////////////////////////////
    /// \brief Get program ROM (PGR) data
    ///
    /// \return Reference to the program ROM data
    ///
    ///////////////////////////////////////////////////////////////////////////
    const Rom<Byte>& GetPGR(void) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    Rom<Byte>& GetPGR(void);

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Get character ROM (CHR) data
    ///
    /// \return Reference to the character ROM data
    ///
    ///////////////////////////////////////////////////////////////////////////
    const Rom<Byte>& GetCHR(void) const;
    ...
    ///
    ///////////////////////////////////////////////////////////////////////////
    Rom<Byte>& GetCHR(void);

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Get the mapper number
    ///
    /// \return The mapper number used by the cartridge
    ///
    ///////////////////////////////////////////////////////////////////////////
    Uint8 GetMapper(void) const;

    ///////////////////////////////////////////////////////////////////////////
    /// \brief Get the mirroring type
    ///
    /// \return The mirroring type used by the cartridge
    ///
    ///////////////////////////////////////////////////////////////////////////
    MirroringType GetMirroringType(void) const;
